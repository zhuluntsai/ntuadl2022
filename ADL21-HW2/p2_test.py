...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default='./data/train_squad.json', help="A csv or a json file containing the training data."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--test_file", type=str, default='./data/output_ts.json', help="A csv or a json file containing the Prediction data."
    )
    parser.add_argument(
        "--max_seq_length",
        type=int,
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        default='chinese-macbert-large-squad',
...
def main():
    ...
    # tokenizer = AutoTokenizer.from_pretrained('chinese-macbert-large-squad', use_fast=not args.use_slow_tokenizer)
    # config = AutoConfig.from_pretrained('chinese-macbert-large-squad')
