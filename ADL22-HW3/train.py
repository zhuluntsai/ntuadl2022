...
# https://tensorboard.dev/experiment/8oxWyAE8REijNyVb9LhV9Q/
...
model_name = 'mt5-small-finetune-re'
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='mt5-small-finetune-re', help="Where to store the final model.")
...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for k, v in result.items():
            tf_logger.add_scalar(k, v, epoch) 
